...
function getUVCategory(uvIndex) {
    ...
    if (uvIndex <= 2) {
        return { category: '弱い', imagePath: 'images/1.jpg', advice: advice };
    } else if (uvIndex <= 5) {
        advice = '帽子や日傘を使用して、紫外線から肌を守りましょう。';  // アドバイス追加
        return { category: '中程度', imagePath: 'images/2.jpg', advice: advice };
    } else if (uvIndex <= 7) {
        advice = '帽子や日傘、長袖の服で肌をしっかり守りましょう。';
        return { category: '強い', imagePath: 'images/3.jpg', advice: advice };
    } else if (uvIndex <= 10) {
        advice = 'なるべく外出を控え、紫外線から肌を守るために帽子や日傘を使用しましょう。';
        return { category: '非常に強い', imagePath: 'images/4.jpg', advice: advice };
    } else {
        advice = '極力外出を避け、しっかりと紫外線対策を行いましょう。';
        return { category: '極端に強い', imagePath: 'images/5.jpg', advice: advice };
    }
}
